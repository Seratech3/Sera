        ...
        <table v-else class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
          <thead>
            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
              ...
              <th class="min-w-125px">orgnization</th>
          ...
          <tbody class="text-gray-600 fw-semibold">
            <tr v-for="(item, index) in items" :key="item.id">
              ...
              <td>
                <div class="badge badge-light-success fw-bold">{{item.email}}</div>
              </td>

               <td>
                <div class="badge badge-light-success fw-bold">{{item.orgnization}}</div>
              </td>


              <td>
                <div class="badge badge-light-info fw-bold">{{item.message}}</div>
              </td>
  ...
  components: {
    ...
    methods: {
        ...
        async fetchItems(page,query = '') {
          ...
          this.isLoading = true;
            await axios.get('Contacts/getAllItems', {
                params: {
